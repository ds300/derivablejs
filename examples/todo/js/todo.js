...
/*** Global App State ***/
var nextId = (0, _derivable.atom)(0); // uids for the list items to make react happy
function getNextId() {
  return _derivable2['default'].swap(nextId, function (x) {
    return x + 1;
  });
}

var todos = (0, _derivable.atom)((0, _immutable.fromJS)([]));
var hash = (0, _derivable.atom)(window.location.hash);
var newTodoName = (0, _derivable.atom)("");
...
var numTodos = todos.derive(function (ts) {
  return ts.size;
});
...
var allComplete = numTodos.and(numRemaining.not());
...
function hideWhen(condition) {
  var displayType = arguments.length <= 1 || arguments[1] === undefined ? "block" : arguments[1];

  return { display: condition ? "none" : displayType };
}

// render todo list item
function renderTodo(_ref, idx) {
  var id = _ref.id;
  var description = _ref.description;
  var complete = _ref.complete;
  var editing = _ref.editing;

  var _showing = showing.get(),
  ...
  return _react2['default'].createElement(
    'li',
    { key: id, className: (editing ? "editing" : "") + (complete ? " completed" : ""), style: hideWhen(hide) },
    _react2['default'].createElement(
      'div',
      { className: 'view' },
      _react2['default'].createElement('input', { className: 'toggle', type: 'checkbox', checked: complete, onChange: function () {
          return todos.swap(toggleComplete, idx);
        } }),
      _react2['default'].createElement(
        'label',
        { onDoubleClick: function () {
            return todos.swap(editingTodo, idx, true);
          } },
        description
      ),
      _react2['default'].createElement('button', { className: 'destroy', onClick: function (ev) {
          return todos.swap(deleteTodo, idx);
        } })
    ),
    _react2['default'].createElement('input', { className: 'edit',
      defaultValue: description,
      onBlur: handleNameChange,
      onKeyPress: onEnter(function (ev) {
...
var todosRender = (0, _derivable.derivation)(function () {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement('input', { className: 'toggle-all',
      ...
      checked: allDone,
      onChange: function () {
        return todos.swap(markAll, !allDone);
      } }),
    _react2['default'].createElement(
      'label',
      { htmlFor: 'toggle-all' },
    ...
    _react2['default'].createElement(
      'ul',
      { className: 'todo-list' },
      todos.get().map(function (x) {
        return x.toJS();
      }).map(renderTodo).toArray()
    )
  );
});

// footer as derivable
var footerRender = (0, _derivable.derivation)(function () {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'a',
          { className: select('active'), href: '#/active' },
          'Active'
        )
      ),
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'a',
          { className: select('completed'), href: '#/completed' },
          'Completed'
        )
      )
    ),
    _react2['default'].createElement(
      ...
      { className: 'clear-completed',
        ...
        onClick: function () {
          return todos.swap(clearCompleted);
        } },
      'Clear completed'
    )
  );
...
var pageRender = (0, _derivable.derivation)(function () {
  return _react2['default'].createElement(
    'section',
    { className: 'todoapp' },
    _react2['default'].createElement(
...
_react2['default'].render(_react2['default'].createElement(Derivable, { render: pageRender }), document.getElementById("main"));

},{"derivable":2,"immutable":3,"react":158}]},{},[159]);
